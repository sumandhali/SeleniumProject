...
class AddCustomers:
    ...
    lstitemVendors_xpath = "//li[@id='select2-SelectedCustomerRoleIds-result-ssxu-5']"
    ...
    def clickOnCustomersMenu(self):
        action = self.driver.find_element(By.XPATH, self.lnkCustomers_menu_xpath)
        action.click()
    def clickOnCustomersMenuItem(self):
        action=self.driver.find_element(By.XPATH, self.lnkCustomers_menuitem_xpath)
        action.click()


    def clickOnAddnew(self):
        button = self.driver.find_element(By.XPATH, self.btnAddnew_xpath)
        button.click()
